    ...
    this.random_split = function(container) {
        ...
        if (this.random(0, 1) == 0) {
            ...
            region1 = new BspContainer(
                ...
                this.random(1, container.w), container.h
            );
            region2 = new BspContainer(
                container.x + region1.w, container.y,
                container.w - region1.w, container.h
            );
            ...
            region1 = new BspContainer(
                container.x, container.y,
                container.w, this.random(1, container.h)
            );
            region2 = new BspContainer(
                container.x, container.y + region1.h,
                container.w, container.h - region1.h
            );
